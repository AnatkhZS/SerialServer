...
public class TitleFrame extends JFrame {
	...
	public TitleFrame(GraphicsConfiguration gc) {
		super(gc);
		initFrame();
	}

	public TitleFrame(String title) throws HeadlessException {
		super(title);
		initFrame();
	}

	public TitleFrame(String title, GraphicsConfiguration gc) {
		super(title, gc);
		initFrame();
	}
	...
	private void initFrame() {
		titleComponent = new Title(this);
		contentPanel.setBorder(new TitleBorder());
