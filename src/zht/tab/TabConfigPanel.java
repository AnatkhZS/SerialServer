...
import zht.color.ColorPickerCombobox;
import zht.utils.layout.TableLayout;

public class TabConfigPanel extends JPanel {
	private ZHTTabbedPane pane;
	private ZHTRectangleTabbedPane configPane;

	public TabConfigPanel(ZHTTabbedPane pane) {
		this.pane = pane;
		configPane = new ZHTRectangleTabbedPane();
		initGUI();
	}
...
class ColorPanel extends JPanel {
	...
	public ColorPanel(ZHTTabbedPane pane) {
		this.pane = pane;
		initGUI();
	}
...
class BooleanPanel extends JPanel {
	...
	public BooleanPanel(ZHTTabbedPane pane) {
		this.pane = pane;
		initGUI();
	}
...
class NumberPanel extends JPanel {
	...
	public NumberPanel(ZHTTabbedPane pane) {
		this.pane = pane;
		initGUI();
	}
